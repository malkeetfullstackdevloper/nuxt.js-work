...
<template>
  ...
  >
    <!-- Icon sidebar -->
    <div
      class="border-muted-200 dark:border-muted-700 dark:bg-muted-800 pointer-events-auto relative z-20 flex h-full w-[50px] flex-col border-r bg-white transition-all duration-300"
      :class="
        isOpen
          ? ''
